...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../bms_css/table.css">
    <link rel="stylesheet" type="text/css" href="../bms_css/navbar.css">
    <link rel="stylesheet" type="text/css" href="../bms_css/createuser.css">
...
?>
        ...
        <h2 class="text-center pt-4 create-user">Create a User</h2>
        <br>
